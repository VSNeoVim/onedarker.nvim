...
local LSP = {
  ...
  LspDiagnosticsUnderlineError = { fg = C.red, bg = C.none, style = "bold" },
  LspDiagnosticsUnderlineWarning = { fg = C.yellow, bg = C.none, style = "bold" },
  LspDiagnosticsUnderlineInformation = { fg = C.blue, bg = C.none, style = "bold" },
  LspDiagnosticsUnderlineHint = { fg = C.green, bg = C.none, style = "bold" },
