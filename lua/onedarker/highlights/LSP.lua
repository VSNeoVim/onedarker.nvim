...
local LSP = {
  ...
  LspDiagnosticsUnderlineError = { fg = C.red },
  LspDiagnosticsUnderlineWarning = { fg = C.yellow },
  LspDiagnosticsUnderlineInformation = { fg = C.blue },
  LspDiagnosticsUnderlineHint = { fg = C.green },
  DiagnosticUnderlineError = { fg = C.red },
  DiagnosticUnderlineWarn = { fg = C.yellow },
  DiagnosticUnderlineInfo = { fg = C.blue },
  DiagnosticUnderlineHint = { fg = C.green },
