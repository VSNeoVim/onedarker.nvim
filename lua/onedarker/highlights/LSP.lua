...
local LSP = {
  ...
  LspDiagnosticsUnderlineError = { fg = C.none },
  LspDiagnosticsUnderlineWarning = { fg = C.none },
  LspDiagnosticsUnderlineInformation = { fg = C.none },
  LspDiagnosticsUnderlineHint = { fg = C.none },
  DiagnosticUnderlineError = { fg = C.none },
  DiagnosticUnderlineWarn = { fg = C.none },
  DiagnosticUnderlineInfo = { fg = C.none },
  DiagnosticUnderlineHint = { fg = C.none },
