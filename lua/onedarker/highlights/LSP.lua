...
local LSP = {
  ...
  LspDiagnosticsDefaultHint = C.green ,
  LspDiagnosticsVirtualTextError = C.red,
  LspDiagnosticsVirtualTextWarning = C.yellow,
  LspDiagnosticsVirtualTextInformation = C.blue,
  LspDiagnosticsVirtualTextHint = C.green,
  LspDiagnosticsFloatingError = C.red,
  LspDiagnosticsFloatingWarning = C.yellow,
  LspDiagnosticsFloatingInformation = C.blue,
  LspDiagnosticsFloatingHint = C.green,
  DiagnosticFloatingError = C.red,
  DiagnosticFloatingWarn = C.yellow,
  DiagnosticFloatingInfo = C.blue,
  DiagnosticFloatingHint = C.green,
  LspDiagnosticsSignError = C.red,
  LspDiagnosticsSignWarning = C.yellow,
  LspDiagnosticsSignInformation = C.blue,
  LspDiagnosticsSignHint = C.green,
  DiagnosticSignError = C.red,
  DiagnosticSignWarn = C.yellow,
  DiagnosticSignInfo = C.blue,
  DiagnosticSignHint = C.green,
  LspDiagnosticsError = C.red,
  LspDiagnosticsWarning = C.yellow,
  LspDiagnosticsInformation = C.blue,
  LspDiagnosticsHint = C.green,
  LspDiagnosticsUnderlineError = { fg = C.red, style = "underline" },
  LspDiagnosticsUnderlineWarning = { fg = C.yellow, style = "underline" },
  LspDiagnosticsUnderlineInformation = { fg = C.blue, style = "underline" },
  LspDiagnosticsUnderlineHint = { fg = C.green, style = "underline" },
  DiagnosticUnderlineError = { fg = C.red, style = "underline" },
  DiagnosticUnderlineWarn = { fg = C.yellow, style = "underline" },
  DiagnosticUnderlineInfo = { fg = C.blue, style = "underline" },
  DiagnosticUnderlineHint = { fg = C.green, style = "underline" },
