...
local LSP = {
  ...
  LspDiagnosticsUnderlineError = { fg = C.red, style = "bold" },
  LspDiagnosticsUnderlineWarning = { fg = C.yellow, style = "bold" },
  LspDiagnosticsUnderlineInformation = { fg = C.blue, style = "bold" },
  LspDiagnosticsUnderlineHint = { fg = C.green, style = "bold" },
  DiagnosticUnderlineError = { fg = C.red, style = "bold" },
  DiagnosticUnderlineWarn = { fg = C.yellow, style = "bold" },
  DiagnosticUnderlineInfo = { fg = C.blue, style = "bold" },
  DiagnosticUnderlineHint = { fg = C.green, style = "bold" },
